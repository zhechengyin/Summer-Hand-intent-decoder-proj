...
- Phase 5a is registered to test whether access to 64 neural channels justifies
  a wider input. It compares 64/64 and 48/48 networks for 30 epochs each while
  keeping January closed and every non-architecture training choice fixed.
...
experiments/active/      Phase-0a audit and pending Phase-5a controlled experiment
...
test, Phase 3 covers label-free drift detection, Phase 4 covers the completed
32-channel architecture study, and Phase 5 starts the 64-channel study.
...
Phase 5a is a new pre-January experiment. Its two generated checkpoints remain
under the Phase-5a result directory until the comparison is reviewed; neither
may overwrite or silently replace the retained 32-channel runtime.
