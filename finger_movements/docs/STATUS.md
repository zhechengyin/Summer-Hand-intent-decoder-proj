...
`models/cssd_lda/`. Each prediction at point A uses a 400 ms
...
```text
models/cssd_lda/model.py
```

Checkpoint:

```text
models/cssd_lda/checkpoints/finger_movements_cssd_lda_phase2c_causal_400ms.npz
```
...
```text
history/experiments/phase2c_bin_window_sweep.py
```
...
```text
history/experiments/phase2d_evaluate_frozen_test.py
...
```text
history/experiments/phase2e_lightweight_regularization_comparison.py
...
```text
history/experiments/phase2f_low_dimensional_riemannian.py
