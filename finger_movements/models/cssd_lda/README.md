...
`history/results/phase2d_official_test_400ms/`; it did not
...
```bash
python finger_movements/models/cssd_lda/train_checkpoint.py
```
...
reference are preserved under `history/models/`.
