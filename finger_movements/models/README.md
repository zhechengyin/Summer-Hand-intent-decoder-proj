...
OOF balanced accuracy was 83.99% across seeds 42/43/44 with five folds per
seed.
...
are archived; the active model and checkpoint remain Phase 2c.
...
other retired checkpoints remain under `history/models/`.
