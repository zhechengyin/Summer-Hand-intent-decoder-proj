/**
  ...
  ******************************************************************************
  */
#ifndef AI_INDY_GRU_HIDDEN_HEAD_H
#define AI_INDY_GRU_HIDDEN_HEAD_H

#include "indy_gru_hidden_head_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_INDY_GRU_HIDDEN_HEAD_MODEL_NAME          "indy_gru_hidden_head"
#define AI_INDY_GRU_HIDDEN_HEAD_ORIGIN_MODEL_NAME   "gru_hidden_head"

/******************************************************************************/
#define AI_INDY_GRU_HIDDEN_HEAD_ACTIVATIONS_ALIGNMENT   (4)
#define AI_INDY_GRU_HIDDEN_HEAD_INPUTS_IN_ACTIVATIONS   (4)
#define AI_INDY_GRU_HIDDEN_HEAD_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_INDY_GRU_HIDDEN_HEAD_IN_NUM        (1)

AI_DEPRECATED
#define AI_INDY_GRU_HIDDEN_HEAD_IN \
  ai_indy_gru_hidden_head_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_INDY_GRU_HIDDEN_HEAD_IN_SIZE { \
  AI_INDY_GRU_HIDDEN_HEAD_IN_1_SIZE, \
}
#define AI_INDY_GRU_HIDDEN_HEAD_IN_SIZE_BYTES { \
  AI_INDY_GRU_HIDDEN_HEAD_IN_1_SIZE_BYTES, \
}
#define AI_INDY_GRU_HIDDEN_HEAD_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_INDY_GRU_HIDDEN_HEAD_IN_1_HEIGHT      (50)
#define AI_INDY_GRU_HIDDEN_HEAD_IN_1_CHANNEL     (64)
#define AI_INDY_GRU_HIDDEN_HEAD_IN_1_SIZE        (3200)
#define AI_INDY_GRU_HIDDEN_HEAD_IN_1_SIZE_BYTES  (12800)

/******************************************************************************/
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_NUM       (2)

AI_DEPRECATED
#define AI_INDY_GRU_HIDDEN_HEAD_OUT \
  ai_indy_gru_hidden_head_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_INDY_GRU_HIDDEN_HEAD_OUT_SIZE { \
  AI_INDY_GRU_HIDDEN_HEAD_OUT_1_SIZE, \
  AI_INDY_GRU_HIDDEN_HEAD_OUT_2_SIZE, \
}
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_SIZE_BYTES { \
  AI_INDY_GRU_HIDDEN_HEAD_OUT_1_SIZE_BYTES, \
  AI_INDY_GRU_HIDDEN_HEAD_OUT_2_SIZE_BYTES, \
}
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_1_HEIGHT      (50)
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_1_CHANNEL     (2)
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_1_SIZE        (100)
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_1_SIZE_BYTES  (400)
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_2_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_2_HEIGHT      (50)
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_2_CHANNEL     (64)
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_2_SIZE        (3200)
#define AI_INDY_GRU_HIDDEN_HEAD_OUT_2_SIZE_BYTES  (12800)

/******************************************************************************/
#define AI_INDY_GRU_HIDDEN_HEAD_N_NODES (2)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup indy_gru_hidden_head
 ...
 * @ref ai_indy_gru_hidden_head_create. Both the activations memory buffer 
 ...
 * using @ref ai_indy_gru_hidden_head_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_indy_gru_hidden_head_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_indy_gru_hidden_head_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_INDY_GRU_HIDDEN_HEAD_*
 * defines into file @ref indy_gru_hidden_head.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_indy_gru_hidden_head_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_INDY_GRU_HIDDEN_HEAD_H */
