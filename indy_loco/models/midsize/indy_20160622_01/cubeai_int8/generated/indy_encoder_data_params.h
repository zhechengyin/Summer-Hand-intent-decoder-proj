...
#define AI_INDY_ENCODER_DATA_ACTIVATIONS_SIZES \
  { 38400, }
#define AI_INDY_ENCODER_DATA_ACTIVATIONS_SIZE     (38400)
#define AI_INDY_ENCODER_DATA_ACTIVATIONS_COUNT    (1)
#define AI_INDY_ENCODER_DATA_ACTIVATION_1_SIZE    (38400)



#define AI_INDY_ENCODER_DATA_WEIGHTS_SIZES \
  { 62860, }
#define AI_INDY_ENCODER_DATA_WEIGHTS_SIZE         (62860)
#define AI_INDY_ENCODER_DATA_WEIGHTS_COUNT        (1)
#define AI_INDY_ENCODER_DATA_WEIGHT_1_SIZE        (62860)
