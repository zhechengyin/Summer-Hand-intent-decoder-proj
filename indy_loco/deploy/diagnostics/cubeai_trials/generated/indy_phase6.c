...
#include "indy_phase6.h"
#include "indy_phase6_data.h"
...
#define AI_NET_OBJ_INSTANCE g_indy_phase6
 
#undef AI_INDY_PHASE6_MODEL_SIGNATURE
#define AI_INDY_PHASE6_MODEL_SIGNATURE     "0xcab45ffee55505682a531d22729b030d"
...
#define AI_TOOLS_DATE_TIME   "2026-08-19T20:11:31-0400"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_INDY_PHASE6_N_BATCHES
#define AI_INDY_PHASE6_N_BATCHES         (1)

static ai_ptr g_indy_phase6_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_indy_phase6_weights_map[1] = AI_C_ARRAY_INIT;
...
/* Array#32 */
AI_ARRAY_OBJ_DECLARE(
  _gru_GRU_output_0_in_transpose_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 3200, AI_STATIC)
...
/* Array#35 */
AI_ARRAY_OBJ_DECLARE(
  _gru_GRU_output_0_out_0_transpose_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 3200, AI_STATIC)

/* Array#36 */
AI_ARRAY_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_in_transpose_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 3200, AI_STATIC)

/* Array#37 */
AI_ARRAY_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 100, AI_STATIC)

/* Array#38 */
AI_ARRAY_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_out_transpose_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 100, AI_STATIC)

/* Array#39 */
AI_ARRAY_OBJ_DECLARE(
  velocity_norm_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 100, AI_STATIC)

/* Array#40 */
AI_ARRAY_OBJ_DECLARE(
  velocity_norm_Transpose_0_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 100, AI_STATIC)
...
/* Array#44 */
AI_ARRAY_OBJ_DECLARE(
  head_bias_3D_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#62 */
AI_ARRAY_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_weights_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Tensor #26 */
AI_TENSOR_OBJ_DECLARE(
  _gru_GRU_output_0_in_transpose_output, AI_STATIC,
  26, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 1, 50), AI_STRIDE_INIT(4, 4, 4, 256, 256),
  1, &_gru_GRU_output_0_in_transpose_output_array, NULL)
...
/* Tensor #29 */
AI_TENSOR_OBJ_DECLARE(
  _gru_GRU_output_0_out_0_transpose_output, AI_STATIC,
  29, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 1, 50), AI_STRIDE_INIT(4, 4, 4, 256, 256),
  1, &_gru_GRU_output_0_out_0_transpose_output_array, NULL)

/* Tensor #30 */
AI_TENSOR_OBJ_DECLARE(
  _gru_GRU_output_0_out_0_transpose_output0, AI_STATIC,
  30, 0x0,
...
/* Tensor #32 */
AI_TENSOR_OBJ_DECLARE(
  _gru_GRU_output_0_output00, AI_STATIC,
  32, 0x0,
  AI_SHAPE_INIT(4, 1, 50, 64, 1), AI_STRIDE_INIT(4, 4, 4, 200, 12800),
  1, &_gru_GRU_output_0_output0_array, NULL)
...
/* Tensor #36 */
AI_TENSOR_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_in_transpose_output, AI_STATIC,
  36, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 1, 50), AI_STRIDE_INIT(4, 4, 4, 256, 256),
  1, &_head_MatMul_output_0_gemm_to_dense_in_transpose_output_array, NULL)

/* Tensor #37 */
AI_TENSOR_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_out_transpose_output, AI_STATIC,
  37, 0x0,
  AI_SHAPE_INIT(4, 1, 50, 1, 2), AI_STRIDE_INIT(4, 4, 4, 200, 200),
  1, &_head_MatMul_output_0_gemm_to_dense_out_transpose_output_array, NULL)

/* Tensor #38 */
AI_TENSOR_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_output, AI_STATIC,
  38, 0x0,
  AI_SHAPE_INIT(4, 1, 2, 1, 50), AI_STRIDE_INIT(4, 4, 4, 8, 8),
  1, &_head_MatMul_output_0_gemm_to_dense_output_array, NULL)

/* Tensor #39 */
AI_TENSOR_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_weights, AI_STATIC,
  39, 0x0,
  AI_SHAPE_INIT(4, 64, 2, 1, 1), AI_STRIDE_INIT(4, 4, 256, 512, 512),
  1, &_head_MatMul_output_0_gemm_to_dense_weights_array, NULL)
...
/* Tensor #66 */
AI_TENSOR_OBJ_DECLARE(
  velocity_norm_Transpose_0_output, AI_STATIC,
  66, 0x0,
  AI_SHAPE_INIT(4, 1, 2, 1, 50), AI_STRIDE_INIT(4, 4, 4, 8, 8),
  1, &velocity_norm_Transpose_0_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  velocity_norm_Transpose_0_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &velocity_norm_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &velocity_norm_Transpose_0_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  velocity_norm_Transpose_0_layer, 1,
  TRANSPOSE_TYPE, 0x0, NULL,
  transpose, forward_transpose,
  &velocity_norm_Transpose_0_chain,
  NULL, &velocity_norm_Transpose_0_layer, AI_STATIC, 
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &head_bias_3D, &_head_MatMul_output_0_gemm_to_dense_out_transpose_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &velocity_norm_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_out_transpose_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_head_MatMul_output_0_gemm_to_dense_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_head_MatMul_output_0_gemm_to_dense_out_transpose_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_out_transpose_layer, 63,
  TRANSPOSE_TYPE, 0x0, NULL,
  transpose, forward_transpose,
  &_head_MatMul_output_0_gemm_to_dense_out_transpose_chain,
  NULL, &velocity_norm_layer, AI_STATIC, 
  .out_mapping = AI_SHAPE_INIT(6, AI_SHAPE_IN_CHANNEL, AI_SHAPE_HEIGHT, AI_SHAPE_WIDTH, AI_SHAPE_CHANNEL, AI_SHAPE_DEPTH, AI_SHAPE_EXTENSION), 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_head_MatMul_output_0_gemm_to_dense_in_transpose_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_head_MatMul_output_0_gemm_to_dense_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_head_MatMul_output_0_gemm_to_dense_weights),
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_layer, 63,
  DENSE_TYPE, 0x0, NULL,
  dense, forward_dense,
  &_head_MatMul_output_0_gemm_to_dense_chain,
  NULL, &_head_MatMul_output_0_gemm_to_dense_out_transpose_layer, AI_STATIC, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_in_transpose_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_gru_GRU_output_0_out_0_transpose_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_head_MatMul_output_0_gemm_to_dense_in_transpose_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  _head_MatMul_output_0_gemm_to_dense_in_transpose_layer, 63,
  TRANSPOSE_TYPE, 0x0, NULL,
  transpose, forward_transpose,
  &_head_MatMul_output_0_gemm_to_dense_in_transpose_chain,
  NULL, &_head_MatMul_output_0_gemm_to_dense_layer, AI_STATIC, 
  .out_mapping = AI_SHAPE_INIT(6, AI_SHAPE_IN_CHANNEL, AI_SHAPE_HEIGHT, AI_SHAPE_WIDTH, AI_SHAPE_CHANNEL, AI_SHAPE_DEPTH, AI_SHAPE_EXTENSION), 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  _gru_GRU_output_0_out_0_transpose_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_gru_GRU_output_0_output00),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_gru_GRU_output_0_out_0_transpose_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  _gru_GRU_output_0_out_0_transpose_layer, 59,
  TRANSPOSE_TYPE, 0x0, NULL,
  transpose, forward_transpose,
  &_gru_GRU_output_0_out_0_transpose_chain,
  NULL, &_head_MatMul_output_0_gemm_to_dense_in_transpose_layer, AI_STATIC, 
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &_gru_GRU_output_0_in_transpose_output),
...
AI_LAYER_OBJ_DECLARE(
  _gru_GRU_output_0_layer, 59,
  GRU_TYPE, 0x0, NULL,
  gru, forward_gru,
  &_gru_GRU_output_0_chain,
  NULL, &_gru_GRU_output_0_out_0_transpose_layer, AI_STATIC, 
  .n_units = 64, 
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  _gru_GRU_output_0_in_transpose_chain, AI_STATIC_CONST, 4,
...
AI_LAYER_OBJ_DECLARE(
  _gru_GRU_output_0_in_transpose_layer, 59,
  TRANSPOSE_TYPE, 0x0, NULL,
  transpose, forward_transpose,
  &_gru_GRU_output_0_in_transpose_chain,
  NULL, &_gru_GRU_output_0_layer, AI_STATIC, 
...
AI_LAYER_OBJ_DECLARE(
  ...
  NULL, &_gru_GRU_output_0_in_transpose_layer, AI_STATIC, 
  .nl_params = NULL, 
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 348772, 1, 1),
    348772, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 76800, 1, 1),
    76800, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_INDY_PHASE6_IN_NUM, &features_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_INDY_PHASE6_OUT_NUM, &velocity_norm_Transpose_0_output),
  &features_Transpose_layer, 0xe9416388, NULL)
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool indy_phase6_configure_activations(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_activations_map(g_indy_phase6_activations_map, 1, params)) {
    /* Updating activations (byte) offsets */
    
    features_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    features_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    features_Transpose_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 38400);
    features_Transpose_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 38400);
    _spatial_spatial_0_Conv_output_0_scratch0_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_0_Conv_output_0_scratch0_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_0_Conv_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 768);
    _spatial_spatial_0_Conv_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 768);
    _spatial_spatial_1_Transpose_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 13568);
    _spatial_spatial_1_Transpose_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 13568);
    _spatial_spatial_1_normalization_ReduceMean_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_1_normalization_ReduceMean_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_1_normalization_ReduceMean_output_0_Mul_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 200);
    _spatial_spatial_1_normalization_ReduceMean_output_0_Mul_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 200);
    _spatial_spatial_1_normalization_Sub_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 400);
    _spatial_spatial_1_normalization_Sub_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 400);
    _spatial_spatial_1_normalization_Pow_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 13200);
    _spatial_spatial_1_normalization_Pow_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 13200);
    _spatial_spatial_1_normalization_ReduceMean_1_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_1_normalization_ReduceMean_1_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_1_normalization_ReduceMean_1_output_0_Mul_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 200);
    _spatial_spatial_1_normalization_ReduceMean_1_output_0_Mul_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 200);
    _spatial_spatial_1_normalization_Sqrt_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_1_normalization_Sqrt_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_1_normalization_Div_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 13200);
    _spatial_spatial_1_normalization_Div_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 13200);
    _spatial_spatial_1_normalization_Mul_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_1_normalization_Mul_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_1_normalization_Add_1_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _spatial_spatial_1_normalization_Add_1_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _spatial_spatial_1_Transpose_1_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_1_Transpose_1_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _spatial_spatial_2_Relu_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _spatial_spatial_2_Relu_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _convolutions_0_Conv_output_0_scratch0_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _convolutions_0_Conv_output_0_scratch0_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _convolutions_0_Conv_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 25600);
    _convolutions_0_Conv_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 25600);
    _Slice_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _Slice_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _Add_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 25600);
    _Add_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 25600);
    _activation_Relu_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _activation_Relu_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _convolutions_1_Conv_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _convolutions_1_Conv_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _Slice_1_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 26624);
    _Slice_1_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 26624);
    _Add_1_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _Add_1_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _activation_1_Relu_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _activation_1_Relu_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _convolutions_2_Conv_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _convolutions_2_Conv_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _Slice_2_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 27648);
    _Slice_2_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 27648);
    _Add_2_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _Add_2_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _activation_2_Relu_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _activation_2_Relu_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _convolutions_3_Conv_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _convolutions_3_Conv_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _Slice_3_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 29696);
    _Slice_3_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 29696);
    _Add_3_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _Add_3_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _activation_3_Relu_output_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _activation_3_Relu_output_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _gru_GRU_output_0_in_transpose_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _gru_GRU_output_0_in_transpose_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _gru_GRU_output_0_scratch0_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _gru_GRU_output_0_scratch0_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _gru_GRU_output_0_output0_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 25600);
    _gru_GRU_output_0_output0_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 25600);
    _gru_GRU_output_0_output1_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 1536);
    _gru_GRU_output_0_output1_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 1536);
    _gru_GRU_output_0_out_0_transpose_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _gru_GRU_output_0_out_0_transpose_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _head_MatMul_output_0_gemm_to_dense_in_transpose_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _head_MatMul_output_0_gemm_to_dense_in_transpose_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 12800);
    _head_MatMul_output_0_gemm_to_dense_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _head_MatMul_output_0_gemm_to_dense_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    _head_MatMul_output_0_gemm_to_dense_out_transpose_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 400);
    _head_MatMul_output_0_gemm_to_dense_out_transpose_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 400);
    velocity_norm_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    velocity_norm_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 0);
    velocity_norm_Transpose_0_output_array.data = AI_PTR(g_indy_phase6_activations_map[0] + 400);
    velocity_norm_Transpose_0_output_array.data_start = AI_PTR(g_indy_phase6_activations_map[0] + 400);
    return true;
  }
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool indy_phase6_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_weights_map(g_indy_phase6_weights_map, 1, params)) {
    /* Updating weights (byte) offsets */
    
    _spatial_spatial_1_normalization_Constant_output_0_3D_array.format |= AI_FMT_FLAG_CONST;
    _spatial_spatial_1_normalization_Constant_output_0_3D_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 0);
    _spatial_spatial_1_normalization_Constant_output_0_3D_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 0);
    spatial_1_normalization_weight_3D_array.format |= AI_FMT_FLAG_CONST;
    spatial_1_normalization_weight_3D_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 4);
    spatial_1_normalization_weight_3D_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 4);
    spatial_1_normalization_bias_3D_array.format |= AI_FMT_FLAG_CONST;
    spatial_1_normalization_bias_3D_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 260);
    spatial_1_normalization_bias_3D_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 260);
    head_bias_3D_array.format |= AI_FMT_FLAG_CONST;
    head_bias_3D_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 516);
    head_bias_3D_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 516);
    _spatial_spatial_0_Conv_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _spatial_spatial_0_Conv_output_0_weights_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 524);
    _spatial_spatial_0_Conv_output_0_weights_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 524);
    _spatial_spatial_0_Conv_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _spatial_spatial_0_Conv_output_0_bias_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 49676);
    _spatial_spatial_0_Conv_output_0_bias_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 49676);
    _spatial_spatial_1_normalization_ReduceMean_output_0_Mul_scale_array.format |= AI_FMT_FLAG_CONST;
    _spatial_spatial_1_normalization_ReduceMean_output_0_Mul_scale_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 49932);
    _spatial_spatial_1_normalization_ReduceMean_output_0_Mul_scale_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 49932);
    _spatial_spatial_1_normalization_ReduceMean_output_0_Mul_bias_array.format |= AI_FMT_FLAG_CONST;
    _spatial_spatial_1_normalization_ReduceMean_output_0_Mul_bias_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 50132);
    _spatial_spatial_1_normalization_ReduceMean_output_0_Mul_bias_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 50132);
    _spatial_spatial_1_normalization_ReduceMean_1_output_0_Mul_bias_array.format |= AI_FMT_FLAG_CONST;
    _spatial_spatial_1_normalization_ReduceMean_1_output_0_Mul_bias_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 50332);
    _spatial_spatial_1_normalization_ReduceMean_1_output_0_Mul_bias_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 50332);
    _convolutions_0_Conv_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _convolutions_0_Conv_output_0_weights_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 50532);
    _convolutions_0_Conv_output_0_weights_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 50532);
    _convolutions_0_Conv_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _convolutions_0_Conv_output_0_bias_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 99684);
    _convolutions_0_Conv_output_0_bias_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 99684);
    _convolutions_1_Conv_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _convolutions_1_Conv_output_0_weights_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 99940);
    _convolutions_1_Conv_output_0_weights_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 99940);
    _convolutions_1_Conv_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _convolutions_1_Conv_output_0_bias_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 149092);
    _convolutions_1_Conv_output_0_bias_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 149092);
    _convolutions_2_Conv_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _convolutions_2_Conv_output_0_weights_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 149348);
    _convolutions_2_Conv_output_0_weights_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 149348);
    _convolutions_2_Conv_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _convolutions_2_Conv_output_0_bias_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 198500);
    _convolutions_2_Conv_output_0_bias_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 198500);
    _convolutions_3_Conv_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _convolutions_3_Conv_output_0_weights_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 198756);
    _convolutions_3_Conv_output_0_weights_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 198756);
    _convolutions_3_Conv_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _convolutions_3_Conv_output_0_bias_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 247908);
    _convolutions_3_Conv_output_0_bias_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 247908);
    _gru_GRU_output_0_kernel_array.format |= AI_FMT_FLAG_CONST;
    _gru_GRU_output_0_kernel_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 248164);
    _gru_GRU_output_0_kernel_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 248164);
    _gru_GRU_output_0_recurrent_array.format |= AI_FMT_FLAG_CONST;
    _gru_GRU_output_0_recurrent_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 297316);
    _gru_GRU_output_0_recurrent_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 297316);
    _gru_GRU_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _gru_GRU_output_0_bias_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 346468);
    _gru_GRU_output_0_bias_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 346468);
    _gru_GRU_output_0_initial_h_array.format |= AI_FMT_FLAG_CONST;
    _gru_GRU_output_0_initial_h_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 348004);
    _gru_GRU_output_0_initial_h_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 348004);
    _head_MatMul_output_0_gemm_to_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    _head_MatMul_output_0_gemm_to_dense_weights_array.data = AI_PTR(g_indy_phase6_weights_map[0] + 348260);
    _head_MatMul_output_0_gemm_to_dense_weights_array.data_start = AI_PTR(g_indy_phase6_weights_map[0] + 348260);
    return true;
  }
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_indy_phase6_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_INDY_PHASE6_MODEL_NAME,
      .model_signature   = AI_INDY_PHASE6_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_bool ai_indy_phase6_get_report(
  ai_handle network, ai_network_report* report)
{
  ai_network* net_ctx = AI_NETWORK_ACQUIRE_CTX(network);
...
AI_API_ENTRY
ai_error ai_indy_phase6_get_error(ai_handle network)
{
...
AI_API_ENTRY
ai_error ai_indy_phase6_create(
...
AI_API_ENTRY
ai_error ai_indy_phase6_create_and_init(
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
  ai_error err;
  ai_network_params params;

  err = ai_indy_phase6_create(network, AI_INDY_PHASE6_DATA_CONFIG);
  if (err.type != AI_ERROR_NONE) {
    return err;
  }
  
  if (ai_indy_phase6_data_params_get(&params) != true) {
    err = ai_indy_phase6_get_error(*network);
    return err;
  }
#if defined(AI_INDY_PHASE6_DATA_ACTIVATIONS_COUNT)
  /* set the addresses of the activations buffers */
  for (ai_u16 idx=0; activations && idx<params.map_activations.size; idx++) {
    AI_BUFFER_ARRAY_ITEM_SET_ADDRESS(&params.map_activations, idx, activations[idx]);
  }
#endif
#if defined(AI_INDY_PHASE6_DATA_WEIGHTS_COUNT)
  /* set the addresses of the weight buffers */
  for (ai_u16 idx=0; weights && idx<params.map_weights.size; idx++) {
    AI_BUFFER_ARRAY_ITEM_SET_ADDRESS(&params.map_weights, idx, weights[idx]);
  }
#endif
  if (ai_indy_phase6_init(*network, &params) != true) {
    err = ai_indy_phase6_get_error(*network);
  }
  return err;
}
...
AI_API_ENTRY
ai_buffer* ai_indy_phase6_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_indy_phase6_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    AI_NETWORK_OBJ(network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_handle ai_indy_phase6_destroy(ai_handle network)
{
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ok &= indy_phase6_configure_weights(net_ctx, params);
  ok &= indy_phase6_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_indy_phase6_forward(ai_handle network, const ai_buffer* input)
{
