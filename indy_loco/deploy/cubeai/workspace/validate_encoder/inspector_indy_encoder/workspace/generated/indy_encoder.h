/**
  ...
  ******************************************************************************
  */
#ifndef AI_INDY_ENCODER_H
#define AI_INDY_ENCODER_H

#include "indy_encoder_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_INDY_ENCODER_MODEL_NAME          "indy_encoder"
#define AI_INDY_ENCODER_ORIGIN_MODEL_NAME   "indy_phase6_encoder"

/******************************************************************************/
#define AI_INDY_ENCODER_ACTIVATIONS_ALIGNMENT   (4)
#define AI_INDY_ENCODER_INPUTS_IN_ACTIVATIONS   (4)
#define AI_INDY_ENCODER_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_INDY_ENCODER_IN_NUM        (1)

AI_DEPRECATED
#define AI_INDY_ENCODER_IN \
  ai_indy_encoder_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_INDY_ENCODER_IN_SIZE { \
  AI_INDY_ENCODER_IN_1_SIZE, \
}
#define AI_INDY_ENCODER_IN_SIZE_BYTES { \
  AI_INDY_ENCODER_IN_1_SIZE_BYTES, \
}
#define AI_INDY_ENCODER_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_INDY_ENCODER_IN_1_HEIGHT      (50)
#define AI_INDY_ENCODER_IN_1_CHANNEL     (192)
#define AI_INDY_ENCODER_IN_1_SIZE        (9600)
#define AI_INDY_ENCODER_IN_1_SIZE_BYTES  (38400)

/******************************************************************************/
#define AI_INDY_ENCODER_OUT_NUM       (1)

AI_DEPRECATED
#define AI_INDY_ENCODER_OUT \
  ai_indy_encoder_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_INDY_ENCODER_OUT_SIZE { \
  AI_INDY_ENCODER_OUT_1_SIZE, \
}
#define AI_INDY_ENCODER_OUT_SIZE_BYTES { \
  AI_INDY_ENCODER_OUT_1_SIZE_BYTES, \
}
#define AI_INDY_ENCODER_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_INDY_ENCODER_OUT_1_HEIGHT      (50)
#define AI_INDY_ENCODER_OUT_1_CHANNEL     (64)
#define AI_INDY_ENCODER_OUT_1_SIZE        (3200)
#define AI_INDY_ENCODER_OUT_1_SIZE_BYTES  (12800)

/******************************************************************************/
#define AI_INDY_ENCODER_N_NODES (31)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup indy_encoder
 ...
 * @ref ai_indy_encoder_create. Both the activations memory buffer 
 ...
 * using @ref ai_indy_encoder_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_indy_encoder_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_indy_encoder_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_INDY_ENCODER_*
 * defines into file @ref indy_encoder.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_indy_encoder_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_INDY_ENCODER_H */
